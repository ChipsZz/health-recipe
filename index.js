    ...
    <!DOCTYPE html>
        ...
        * {
        ...
        <div class="tab-content">
            ...
            <div class="calendar-container">
                ...
                <div class="preference-section">
                    ...
                    <div class="tags">
                    <div class="tag selected">中式</div>
                    <div class="tag">西式</div>
                    <div class="tag">辣味</div>
                    <div class="tag">素食</div>
                    <div class="tag">高蛋白</div>
                    </div>
                </div>

                <div class="preference-section">
                    <h3><i class="fas fa-ban"></i> 忌口/过敏</h3>
                    <div class="tags">
                    <div class="tag">海鲜</div>
                    <div class="tag selected">花生</div>
                    <div class="tag">乳制品</div>
                    </div>
                </div>
                ...
                <div class="preference-section">
                    ...
                    <div class="tags">
                    <div class="tag selected">控制体重</div>
                    <div class="tag">增肌</div>
                    <div class="tag">改善睡眠</div>
                    </div>
                </div>
                </div>
                ...
                <div class="chat-messages">
                    ...
                    <div class="character">
                        <div class="character-avatar ai-avatar">
                        <i class="fas fa-robot"></i>
                        </div>
                    </div>
                    <div class="message-content">嗨！我是你的AI营养师～今天有什么想吃的吗？或者我来帮你决定？</div>
        ...
        <div class="detail-card-header">
            <div class="detail-card-title" id="detailCardDate">2023年10月15日</div>
            <button class="detail-card-close" id="detailCardClose">&times;</button>
        </div>
        ...
        function renderFoodList() {
            ...
            foodItem.innerHTML = \`<div class="food-name">\${food.food}</div>\`;
        ...
        function showDetailCard(dateStr, records, event) {
            ...
            detailHTML += \`<div class="detail-meal-item">
                            <div class="detail-meal-name"><i class="fas fa-egg" style="color: var(--breakfast);"></i> 早餐</div>
                            \${breakfastRecords.map(record => \`
            ...
            if (lunchRecords.length > 0) {
            detailHTML += \`<div class="detail-meal-item">
                            <div class="detail-meal-name"><i class="fas fa-utensils" style="color: var(--lunch);"></i> 午餐</div>
                            \${lunchRecords.map(record => \`
                                <div class="detail-meal-nutrition">
                                    <span>\${record.name}</span>
                                    <span>\${record.calories}kcal</span>
                                </div>
            ...
            if (dinnerRecords.length > 0) {
            detailHTML += \`<div class="detail-meal-item">
                            <div class="detail-meal-name"><i class="fas fa-moon" style="color: var(--dinner);"></i> 晚餐</div>
                            \${dinnerRecords.map(record =>\`
                                <div class="detail-meal-nutrition">
                                    <span>\${record.name}</span>
                                    <span>\${record.calories}kcal</span>
                                </div>
            ...
            detailHTML += \`<div class="detail-meal-item" style="margin-top: 20px; padding-top: 10px; border-top: 1px solid var(--border);">
                        <div class="detail-meal-name">总计</div>
                        <div class="detail-meal-nutrition">
                            <span>总热量</span>
                            <span style="color: var(--primary-dark); font-weight: bold;">\${totalCalories}kcal</span>
                        </div>
                    </div>\`;
